...
<img class ="blog-inline-image" src="{{ site.baseurl }}/assets/images/preparing-my-personal-balance-sheet/image1.jpeg" alt="image1"/>
...
1. **Monetary Assets**: Cash which is practically present with us at the moment. For example-Money in our wallet, current and savings account balances or if a friend or family owes you some money.

2. **Tangible Assets**: These are assets that we can mostly hold physically. For example-Any personal property like a car, a bike, our electronics, instruments or even the furniture we own which we think are a sort of big cost items.

3. **Investment Assets:** These are mostly the assets whose value is generally growing with time. For example-Investing in stocks, bonds, mutual funds etc. It can even be a property on real estate or maybe employer-sponsored retirement accounts and other insurances. (*Insurances that payout only after we die like life insurances do not count.*)

*The next important thing is liabilities or the debts we owe. Let’s now discuss that.*

The following can be your liabilities:

1. Any kind of current bills, credit card account balances or if we have taken any unpaid services that need to be paid later.
2. If we have borrowed money from friends and family.
3. Rental Utilities and other bills to be paid regularly.
4. Car loans, college or student loans for education, home mortgages or any real estate type mortgages etc.
...
<img class ="blog-inline-image" src="{{ site.baseurl }}/assets/images/preparing-my-personal-balance-sheet/image2.png" alt="image2"/>
